        ...
        <div class="top-section">
            <div class="overlay-content">
                ...
                <div style="text-align: right;margin-right: 20px;">
                    ...
                    <?php endif; ?>
                    <div <?= $userInfoData == null ? 'style="display: none;"' : 'style="font-size: 55px;color: white;text-align: right;margin-right:110px;"' ?> class="title">
                    ...
                    <div <?= $userInfoData == null ? 'style="display: none;"' : '' ?> class="pricePromo">
                        -<?= number_format($userInfoData['refer_registration_bonus'], 0, '', ' ') ?> <small
                            style="font-size: 55px;">₸</small>
                    </div>
                </div>
