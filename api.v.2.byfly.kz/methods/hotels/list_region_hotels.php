...
if (empty($_POST['regionId']) == false) {
    ...
    $query1 = "SELECT * FROM hotels WHERE region_id='" . $_POST['regionId'] . "'" . $query . "  ORDER BY " . $orderBy . " DESC LIMIT " . $pages . ",10";
    $query2 = "SELECT COUNT(id) as ct FROM hotels WHERE region_id='" . $_POST['regionId'] . "'" . $query;
    try {
