...
$listUserAtestationDB = $db->query("SELECT * FROM `users` WHERE `start_atestation` IS NOT NULL AND `end_atestation` IS NOT NULL AND date_validate_agent > '" . date('Y-m-d H:i:s') . "' AND astestation_bal < 90");
