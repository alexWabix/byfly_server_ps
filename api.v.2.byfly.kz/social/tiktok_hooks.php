...
if (empty($_POST) == false) {
    ...
    $data = array(
        ...
        "message" => "Всем общий саламчик! Один из пользователей tiktok проявил инетерес к нашей рекламе нужно с ним связаться побыренькому! Телефон клиента: " . $_POST['phone_number'] . ". Объявление: " . $_POST['ad_name']
    );
