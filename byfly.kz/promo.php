...
$listActivesUserDB = $db->query("SELECT name, famale, avatar, COUNT(*) as agent_count FROM users WHERE user_status='agent' GROUP BY parent_user HAVING agent_count > 10");
$listActivesUsers = [];
...
$listActivesUserDB2 = $db->query("SELECT name, famale, avatar, COUNT(*) as agent_count FROM users WHERE user_status='agent' GROUP BY parent_user");
$listActivesUsers2 = [];
...
<body>
    <div class="container py-5">
        <h1 class="text-center mb-4">Топ Агенты</h1>

        <!-- Section 1: Users traveling in a slider -->
        <div class="mb-5">
