...
if ($_POST['type'] == 'sendForm') {
    ...
    $query = "INSERT INTO `byfly.2.0`.`new_year` (`id`, `fio`, `phone`, `message`, `date_create`) VALUES (NULL, '$fio', '$phone', '$message', CURRENT_TIMESTAMP);";
    $db->query($query);
...
<body>
    ...
    <header class="hero text-white">
        ...
        <p class="lead">Приглашаем вас 30 декабря 2024 года на незабываемую шоу-программу с розыгрышем ценных призов и
            путешествия!</p>
        <p>Мы подведем итоги года и расскажем о планах на будущее. Присоединяйтесь!</p>
        <div class="price">Стоимость участия: 20 000 KZT</div>
    </header>
            ...
            <div class="row">
                <div class="col-md-8 text-dark">
                    ...
                    <p>На этом мероприятии вы сможете полностью окунуться в атмосферу праздника. Вас ждет зажигательная
                        музыка,
                        уникальные шоу, веселая компания и много сюрпризов. Это вечер, который вы не забудете!</p>
                    <p>Приходите, чтобы разделить радость с коллегами и друзьями, а также получить шанс выиграть
                        удивительные
                        призы и путешествия!</p>
