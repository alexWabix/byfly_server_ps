...
$query = $db->query("SELECT * FROM new_year WHERE is_agent='1' AND city='Алматы' AND go = '1' ORDER BY RAND() LIMIT $count");
$winners = [];
...
<head>
    ...
    <title>Розыгрыш для агентов из Алматы</title>
...
<body>
    <h1>🎉 Розыгрыш для агентов из Алматы 🎉</h1>
