...
$query = $db->query("SELECT * FROM new_year WHERE is_agent='1' AND go = '1' ORDER BY RAND() LIMIT $count");
$winners = [];
...
<head>
    ...
    <title>Розыгрыш для агентов из 5 городов</title>
...
<body>
    <h1>🎉 Розыгрыш для агентов из 5 городов 🎉</h1>
