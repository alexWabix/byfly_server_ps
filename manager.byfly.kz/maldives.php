...
sendWhatsapp(
    ...
    "🎉 Поздравляем! 🎉\n\n" .
    "Вы стали победителем суперприза и выиграли тур на Мальдивы! 🌴✈️\n\n" .
    "📅 Дата вылета: 16.03.2025\n" .
    "🕒 Продолжительность: 3 ночи\n" .
    "🌍 Направление: Мальдивы из Алматы\n\n" .
    "👥 Туристы: Взрослых - 2\n" .
    "🏨 Отель: Medhufushi Island Resort 4*\n" .
    "🏡 Номер: Beach Villa Semi Detached\n" .
    "🍲 Питание: Завтрак и ужин\n" .
    "💶 Стоимость тура: 1 481 298 KZT\n\n" .
    "В стоимость входит:\n" .
    "✔️ Перелет\n" .
    "✔️ Проживание\n" .
    "✔️ Питание (завтрак и ужин)\n" .
    "✔️ Трансфер\n" .
    "✔️ Страховка\n\n" .
    "Мы искренне рады за вас и уверены, что этот тур станет незабываемым подарком! 🎊\n\n" .
    "От всей команды ByFly желаем вам плодотворной работы, крупных чеков, невероятных успехов и множества новых клиентов! 💼\n" .
    "Пусть этот выигрыш станет для вас вдохновением на новые достижения и позитивные эмоции. 💪\n\n" .
...
<head>
    ...
    <title>Розыгрыш: Путешествие на Мальдивы для агентов компании ByFly</title>
...
<body>
    <h1>🎉 Розыгрыш: Путешествие на Мальдивы для агентов компании ByFly 🎉</h1>
