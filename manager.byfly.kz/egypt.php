...
$query = $db->query("SELECT * FROM new_year WHERE is_pay='1' AND go = '1' ORDER BY RAND() LIMIT 1");
...
sendWhatsapp(
    ...
    "🎉 Поздравляем! 🎉\n\n" .
    "Вы стали победителем розыгрыша и выиграли тур в Египет! 🌴✈️\n\n" .
    "📅 Дата вылета: 03.03.2025\n" .
    "🕒 Продолжительность: 6 ночей\n" .
    "🌍 Направление: Египет из Алматы\n\n" .
    "👥 Туристы: Взрослых - 2\n" .
    "🏨 Отель: Pickalbatros Royal Moderna Sharm El Sheikh 5*\n" .
    "🏡 Номер: Standard Garden View\n" .
    "🍲 Питание: Все включено\n" .
    "💶 Стоимость тура: 627 898 KZT\n\n" .
    "В стоимость входит:\n" .
    "✔️ Перелет\n" .
    "✔️ Проживание\n" .
    "✔️ Питание (все включено)\n" .
    "✔️ Трансфер\n" .
    "✔️ Страховка\n\n" .
    "Мы искренне рады за вас и надеемся, что этот тур станет незабываемым приключением! 🎊\n\n" .
...
<head>
    ...
    <title>Розыгрыш: Путешествие в Египет</title>
...
<body>
    <h1>🎉 Розыгрыш: Путешествие в Египет 🎉</h1>
