...
$query = $db->query("SELECT * FROM new_year WHERE is_pay='1' AND go = '1' ORDER BY RAND() LIMIT $count");
$winners = [];
...
<head>
    ...
    <title>Розыгрыш для участников из 5 городов</title>
...
<body>
    <h1>🎉 Розыгрыш для участников из 5 городов 🎉</h1>
